...
document.querySelector('.signup-form').addEventListener('submit', async (event) => {
    ...
    try {
        ...
        // Check if the ownerUid matches the reservation for the selected time
        if (horseData.reservationTimes[selectedTime] === horseData.ownerUid) {
            displayMessage('The science is reserved by the owner', 'red');
        } else {
            // Reserve the horse for the admin
